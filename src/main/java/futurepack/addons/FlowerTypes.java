...
public class FlowerTypes
{
	...
	{
		Kristals = AlleleManager.alleleFactory.createFlowers(FPForestryAddon.ID, "kristals", "kristals", new IFlowerProvider()
		{
...
//			}
		...
		Erze = AlleleManager.alleleFactory.createFlowers(FPForestryAddon.ID, "ores", "allores", new IFlowerProvider()
		{
			{
