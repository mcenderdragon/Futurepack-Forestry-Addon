...
public class BeeNeon extends BeeTypes
{

	public BeeNeon(String name, int firstCol, int secondCol)
	{
	...
	public IAllele[] getChromosomes()
	{
		...
		BreedingManager.set(array, EnumBeeChromosome.SPEED, BreedingManager.getEnumAllele("Speed", "NORMAL"));
...
//		BreedingManager.set(array, EnumBeeChromosome.HUMIDITY, null);
		...
		array[EnumBeeChromosome.FLOWER_PROVIDER.ordinal()] = FlowerTypes.Kristals;
		BreedingManager.set(array, EnumBeeChromosome.FLOWERING, BreedingManager.getEnumAllele("Flowering", "SLOW"));
		BreedingManager.set(array, EnumBeeChromosome.TERRITORY, BreedingManager.getEnumAllele("Territory", "LARGE"));
