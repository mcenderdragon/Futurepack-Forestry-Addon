package futurepack.addons.forestry.deprecated;
/*package futurepack.addons.bees;

import forestry.api.apiculture.EnumBeeChromosome;
import forestry.api.genetics.IAllele;

public class BeeMenelaus extends BeeTypes
{

	public BeeMenelaus(String name, int firstCol, int secondCol)
	{
	...
	public IAllele[] getChromosomes()
	{
		...
		BreedingManager.set(array, EnumBeeChromosome.NEVER_SLEEPS, false);
//		BreedingManager.set(array, EnumBeeChromosome.HUMIDITY, null);
		...
		BreedingManager.set(array, EnumBeeChromosome.FLOWER_PROVIDER, BreedingManager.getEnumAllele("Flowers", "CACTI"));
		BreedingManager.set(array, EnumBeeChromosome.FLOWERING, BreedingManager.getEnumAllele("Flowering", "SLOWEST"));
		BreedingManager.set(array, EnumBeeChromosome.TERRITORY, BreedingManager.getEnumAllele("Territory", "LARGEST"));
